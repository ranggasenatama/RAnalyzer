...
class MyUI extends RAnalyzerUI
{
    /**
     * Creates new form RAnalyzerUI
     */
    public MyUI() {
        initMyComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RAnalyzerUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RAnalyzerUI().setVisible(true);
            }
        });
    }

    // Variables declaration
    private MyButton newProjectBtn;
